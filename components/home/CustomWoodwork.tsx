                ...
                <div className="rounded-sm border p-8 sm:p-12 bg-surface border-border shadow-2xl">
                    <div className=" gap-12">
                        ...
                        <Link
                            ...
                            className="block w-full mt-6 bg-primary hover:bg-accent text-primary-foreground text-center py-3 text-sm font-semibold uppercase rounded-sm transition-colors"
                        >
